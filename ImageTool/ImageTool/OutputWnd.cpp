...
int COutputWnd::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndOutputBuild.Create(dwStyle, rectDummy, &m_wndTabs, 2) ||
		...
		!m_wndOutputInfo.Create(dwStyle, rectDummy, &m_wndTabs, 5))
	{
	...
	bNameValid = strTabName.LoadString(IDS_OUTPUT_INFO);
	ASSERT(bNameValid);
	m_wndTabs.AddTab(&m_wndOutputInfo, strTabName, (UINT)3);
